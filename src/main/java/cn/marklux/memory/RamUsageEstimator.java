package cn.marklux.memory;

/*
 * 【Notice】source code from apache lucene version 4.0.0
 *
...
public final class RamUsageEstimator {
    ...
    public static long sizeOf(byte[] arr) {
        return arr == null ? 0L : alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + arr.length);
    }
    ...
    public static long sizeOf(char[] arr) {
        return arr == null ? 0L : alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_CHAR * arr.length);
    }
    ...
    public static long sizeOf(short[] arr) {
        return arr == null ? 0L: alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_SHORT * arr.length);
    }
    ...
    public static long sizeOf(int[] arr) {
        return arr == null ? 0L : alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_INT * arr.length);
    }
    ...
    public static long sizeOf(float[] arr) {
        return arr == null ? 0L : alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_FLOAT * arr.length);
    }
    ...
    public static long sizeOf(long[] arr) {
        return arr == null ? 0L : alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_LONG * arr.length);
    }
    ...
    public static long sizeOf(double[] arr) {
        return arr == null ? 0L : alignObjectSize((long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_DOUBLE * arr.length);
    }
